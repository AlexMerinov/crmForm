...
const addStrokeBtn = document.querySelector('[data-add-item]');
const tableItem    = document.querySelector('[data-item-table]');
const table        = document.querySelector('[data-table]');

function createTableItem(){
   let newStroke = document.createElement('form');
   newStroke.className = "table__form";
   newStroke.innerHTML = `<span class="table-item-count">1.</span>
 ...
 document.onclick = function(event) {
   if (event.target.className == 'table-input-remove'){
